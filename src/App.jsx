      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-about-col">
            ...
            <p>
              An MCA Fresher specializing in Java Full Stack and MERN Stack development. Seeking software engineering opportunities.
            </p>
          </div>
          <div className="footer-links-col">
            ...
            <ul className="footer-links-grid">
              ...
              <li className="footer-link-item"><a href="#skills">Skills</a></li>
              <li className="footer-link-item"><a href="#projects">Projects</a></li>
              <li className="footer-link-item"><a href="#education">Education</a></li>
              <li className="footer-link-item"><a href="#certifications">Certs</a></li>
              <li className="footer-link-item"><a href="#resume">Resume</a></li>
