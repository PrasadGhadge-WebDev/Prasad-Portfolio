      ...
      <div className="nav-container">
        ...
        <div className="nav-right">
          <ul className={`nav-links ${isMenuOpen ? 'active' : ''}`}>
            ...
            <li><a href="#certifications" className={`nav-link ${activeSection === 'certifications' ? 'active' : ''}`} onClick={closeMenu}>Certs</a></li>
            <li><a href="#resume" className={`nav-link ${activeSection === 'resume' ? 'active' : ''}`} onClick={closeMenu}>Resume</a></li>
