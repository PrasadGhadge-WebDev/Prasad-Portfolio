    ...
    <section id="resume" className="section">
      ...
      <div className="resume-preview-container">
        ...
        <div className="resume-preview-box">
          ...
          <div className="resume-section-content">
            ...
            <p className="resume-item-details">
              Post-Graduation, specialized in Databases and Java Enterprise architectures.
            </p>
            ...
            <p className="resume-item-details">
              Acquired business analytics and systems administration fundamentals.
            </p>
          </div>
          ...
          <div className="resume-section-content">
            <p>
              <strong>Languages:</strong> Java (SE/EE), JavaScript, SQL, HTML5, CSS3
            </p>
            <p>
              <strong>Frameworks:</strong> React.js, JSP, Servlets, JDBC, Node.js, Express
            </p>
            <p>
              <strong>Databases & Tools:</strong> MySQL, MongoDB, Git, GitHub, DBMS Systems
            </p>
          </div>
          ...
          <div className="resume-section-content">
            ...
            <p className="resume-item-details">
              Built catalog systems and local storage basket checkout pathways.
            </p>
            ...
            <p className="resume-item-details">
              Created a full-stack seats organizer showing live ticketing stats.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          >
            I am actively applying for <strong>Java Full Stack Developer</strong>,{' '}
            <strong>Software Developer</strong>, and <strong>MERN Stack Developer</strong> roles.
            Review my qualifications, download my complete resume, and let's discuss how I can add
            value to your team.
          </p>
          <a
